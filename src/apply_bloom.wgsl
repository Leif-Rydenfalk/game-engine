...
fn get_bloom(coord: vec2<f32>) -> vec3<f32> {
    ...
    bloom += textureSample(t_bloom, s, (coord / exp2(5.0)) - calc_offset(4.0)).rgb * 1.0;
    bloom += textureSample(t_bloom, s, (coord / exp2(6.0)) - calc_offset(5.0)).rgb * 1.5;
    bloom += textureSample(t_bloom, s, (coord / exp2(7.0)) - calc_offset(6.0)).rgb * 1.0;
    bloom += textureSample(t_bloom, s, (coord / exp2(8.0)) - calc_offset(7.0)).rgb * 1.5;
    return bloom;
}
